...
export const CrmCustomerReqSchema = Type.Object({
  numberId: Type.Optional(Type.String({ maxLength: 20 })),
  name: Type.String({ minLength: 1, maxLength: 50 }),
  gender: Type.Optional(Type.Integer({ minimum: 0, maximum: 2 })),
  birthday: Type.Optional(Type.String({ format: 'date' })),
  telphone: Type.Optional(Type.String({ maxLength: 20 })),
  mobile: Type.Optional(Type.String({ maxLength: 20, pattern: '^1[3-9]\\d{9}$' })),
  qq: Type.Optional(Type.String({ maxLength: 20, pattern: '^[1-9]\\d{4,14}$' })),
  wechat: Type.Optional(Type.String({ maxLength: 50, pattern: '^[a-zA-Z][a-zA-Z0-9_-]{5,49}$' })),
  ...
  plastic: Type.Optional(Type.String({ maxLength: 255 })),
  statusId: Type.Optional(Type.Integer({ minimum: 1 })),
  remark: Type.Optional(Type.String({ maxLength: 5000 })),
