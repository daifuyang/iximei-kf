...
import { sysUser } from '@/db/schema/tables'
...
// STRICT-SPEC §3.1.6：crm_hospital_account 表已物理删除；Drizzle 定义与所有索引同步移除。
// 一院一账号由 crm_hospital.account_user_id 唯一定位，禁止重新引入该表。
